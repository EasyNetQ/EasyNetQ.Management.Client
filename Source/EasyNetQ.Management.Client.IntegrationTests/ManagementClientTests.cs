...
namespace EasyNetQ.Management.Client.IntegrationTests
{
    ...
    public class ManagementClientTests
    {
        ...
        {
            return managementClient.CreateExchangeAsync(new ExchangeInfo(exchangeName, "direct"), Configuration.RabbitMqVirtualHost);
        }
        ...
        public async Task Should_be_able_to_create_an_exchange_with_plus_char_in_the_name()
        {
            ...
            var queue = await managementClient.CreateExchangeAsync(exhangeInfo, Configuration.RabbitMqVirtualHost).ConfigureAwait(false);
        ...
        {
            await CreateTestQueue(testQueue).ConfigureAwait(false);
            var queue = await managementClient.GetQueueAsync(testQueue, Configuration.RabbitMqVirtualHost).ConfigureAwait(false);
        ...
        public async Task Should_be_able_to_get_a_queue_by_name_with_plus_char()
        {
            ...
            var queue = await managementClient.GetQueueAsync(testQueueWithPlusChar, Configuration.RabbitMqVirtualHost).ConfigureAwait(false);
        ...
        public async Task Should_be_able_to_get_a_queue_by_name_with_detailed_length_information()
        {
            ...
            var queue = await managementClient.GetQueueAsync(testQueue, Configuration.RabbitMqVirtualHost, lengthsCriteria: new GetLengthsCriteria(age, increment)).ConfigureAwait(false);
        ...
        public async Task Should_be_able_to_get_a_queue_by_name_with_detailed_rates_information()
        {
            ...
            await CreateTestQueue(testQueue).ConfigureAwait(false);
            var queue = await managementClient.GetQueueAsync(testQueue, Configuration.RabbitMqVirtualHost, ratesCriteria: new GetRatesCriteria(age, increment)).ConfigureAwait(false);
            queue.Name.ShouldEqual(testQueue);
        }
        ...
        public async Task Should_be_able_to_get_a_queue_by_name_with_all_detailed_information()
        {
            ...
            var queue = await managementClient.GetQueueAsync(testQueue, Configuration.RabbitMqVirtualHost, lengthsCriteria: new GetLengthsCriteria(age, increment), ratesCriteria: new GetRatesCriteria(age, increment)).ConfigureAwait(false);
        ...
        public async Task Should_be_able_to_get_a_list_of_bindings_between_an_exchange_and_an_exchange()
        {
            ...
            var bindings = (await managementClient.GetBindingsAsync(exchange1, exchange2).ConfigureAwait(false)).ToArray();
        ...
        public async Task Should_be_able_to_change_the_password_of_a_user()
        {
            ...
            var updatedUser = await managementClient.ChangeUserPasswordAsync(testUser, "newPassword").ConfigureAwait(false);
        ...
        public async Task Should_be_able_to_create_policies()
        {
            ...
            Assert.Equal(1, (await managementClient.GetPoliciesAsync().ConfigureAwait(false)).Count(
                p => p.Name == policyName
                     ...
                     && p.Definition.HaSyncBatchSize == batchsize));
        }
        ...
        public async Task Should_be_able_to_create_parameter()
        {
            ...
            Assert.Contains(await managementClient.GetParametersAsync().ConfigureAwait(false), p => p.Name == "myfakefederationupstream1");
        }
